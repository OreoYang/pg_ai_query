...
#define PG_AI_PROVIDER_CONFIG(provider) pg_ai::config::ConfigManager::getProviderConfig(provider)
#define PG_AI_MODEL_CONFIG(model) pg_ai::config::ConfigManager::getModelConfig(model)
